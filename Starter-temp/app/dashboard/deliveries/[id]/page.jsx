                ...
                <div className="flex flex-col gap-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-2xl font-bold tracking-tight">Delivery {delivery.reference}</h1>
                        </div>
                        ...
                        <CardContent className="p-6 grid gap-6 md:grid-cols-2">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <div className="font-medium text-lg">{delivery.reference}</div>
                                </div>
                                <div className="space-y-2">
                                    <Label>Customer (To/Contact)</Label>
                                    <Input value={delivery.customer || ""} readOnly className="bg-transparent border-x-0 border-t-0 rounded-none px-0" />
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input value={format(new Date(delivery.date), "yyyy-MM-dd")} readOnly className="bg-transparent border-x-0 border-t-0 rounded-none px-0" />
                                </div>
                                <div className="space-y-2">
                                    <Label>Status</Label>
